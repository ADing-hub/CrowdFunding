package com.ding.crowd.util.exception;

/**
 * @author Qidong Ding
 * @description TODO：保存或更新Admin时如果检测到登录帐号重复则抛出这个异常
...
public class LoginAcctAlreadyInUserForUpdateException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected LoginAcctAlreadyInUserForUpdateException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
